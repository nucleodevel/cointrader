...
import net.blinktrade.tradeapi.to.Withdrawal;
...
public class TradeApiService extends AbstractApiService {
	 ...
	 */
	public TradeApiService(String mbTapiCode, String mbTapiKey) throws BlinktradeException {
		super();
		
		if (mbTapiCode == null) {
			throw new BlinktradeException("Null code.");
		}
		
		if (mbTapiKey == null) {
			throw new BlinktradeException("Null key.");
		}
	 ...
	 * @throws BlinktradeException Generic exception to point the cause of any possible problem with the execution.
	 * @throws NetworkErrorException 
	 */
	public AccountBalance getAccountInfo() throws BlinktradeException, NetworkErrorException {
	 ...
	 * @throws NetworkErrorException 
	 */
	public List<Order> listOrders(OrderFilter filter) throws BlinktradeException, NetworkErrorException {
		if (filter == null) {
			throw new BlinktradeException("Invalid filter.");
		}
	...
	private Order createOrder(Order order) throws BlinktradeException, NetworkErrorException {
		if (order == null) {
			throw new BlinktradeException("Invalid order.");
		}
	 ...
	 * @throws NetworkErrorException 
	 */
	public Order createBuyOrder(CoinPair coin, String volume, String price) throws BlinktradeException, NetworkErrorException {
	 ...
	 * @throws NetworkErrorException 
	 */
	public Order createSellOrder(CoinPair coin, String volume, String price) throws BlinktradeException, NetworkErrorException {
	 ...
	 * @throws NetworkErrorException 
	 */
	public Order cancelOrder(Order order) throws BlinktradeException, NetworkErrorException {
		if (order == null) {
			throw new BlinktradeException("Invalid filter.");
		}
	 ...
	 * @throws NetworkErrorException 
	 */
	public Withdrawal withdrawalBitcoin(String bitcoinAddress, BigDecimal volume) throws BlinktradeException, NetworkErrorException {
		if (bitcoinAddress == null) {
			throw new BlinktradeException("Invalid Bitcoin address.");
		}

		if (volume == null || volume.compareTo(BigDecimal.ZERO) == -1) {
			throw new BlinktradeException("Invalid volume.");
		}
	...
	private JsonObject makeRequest(String method) throws BlinktradeException, NetworkErrorException {
		return makeRequest(new JsonHashMap(), method);
	}
	
	private JsonObject makeRequest(JsonHashMap params, String method) throws BlinktradeException, NetworkErrorException {
		...
		if (jsonResponse == null) {
			throw new BlinktradeException("Internal error: null response from the server.");
		}
		
		JsonObject jsonObject = JsonObject.readFrom(jsonResponse);
		if (jsonObject.get("success").asInt() == 0) {
			throw new BlinktradeException(jsonObject.get("error").asString());
		}
	...
	private String invokeTapiMethod(JsonHashMap params) throws BlinktradeException, NetworkErrorException {
		try {
			...
			throw new BlinktradeException("Internal error: Cryptography Algorithm not found.");
		} catch (InvalidKeyException e) {
			throw new BlinktradeException("Invalid Key or Signature.");
		} 
	}
