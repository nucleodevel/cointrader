...
import net.blinktrade.util.TimestampInterval;
...
public class ApiService extends AbstractApiService {
	...
	public ApiService() throws BlinktradeException {
		super();
	}
	 ...
	 */
	public Ticker ticker24h(CoinPair coinPair) throws BlinktradeException {
	 ...
	 * @throws BlinktradeException Generic exception to point any error with the execution.
	 */
	public Ticker tickerOfToday(CoinPair coinPair) throws BlinktradeException {
	 ...
	 * @throws BlinktradeException Generic exception to point any error with the execution.
	 */
	public Orderbook orderbook(CoinPair coinPair) throws BlinktradeException {
	 ...
	 * @throws BlinktradeException Generic exception to point any error with the execution.
	 */
	public Operation[] tradeList(CoinPair coinPair) throws BlinktradeException {
	 ...
	 * @throws BlinktradeException Generic exception to point any error with the execution.
	 */
	public Operation[] tradeList(CoinPair coinPair, long initialTid) throws BlinktradeException {
		if (initialTid < 0) {
			throw new BlinktradeException("Invalid initial tid.");
		}
	 ...
	 * @throws BlinktradeException Generic exception to point any error with the execution.
	 */
	public Operation[] tradeList(CoinPair coinPair, TimestampInterval interval) throws BlinktradeException {
		if (interval == null) {
			throw new BlinktradeException("Invalid date interval.");
		}
	...
	private Operation[] tradeList(CoinPair coinPair, String ... complements) throws BlinktradeException {
	 ...
	 */
	private String assemblyUrl(CoinPair coinPair, String method, String ... pathParams) throws BlinktradeException {
		if (coinPair == null) {
			throw new BlinktradeException("Invalid coin pair.");
		}
	...
	private String invokeApiMethod(String params) throws BlinktradeException {
		try {
			...
			throw new BlinktradeException("Internal error: Invalid URL.");
		} catch (IOException e) {
			e.printStackTrace();
			throw new BlinktradeException("Internal error: Failure in connection.");
		}
	}
