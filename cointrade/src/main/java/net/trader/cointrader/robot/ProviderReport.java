package net.trader.cointrader.robot;
...
import net.trader.cointrader.api.blinktrade.BlinktradeApiService;
import net.trader.cointrader.api.mercadobitcoin.MercadoBitcoinApiService;
import net.trader.cointrader.api.poloniex.PoloniexApiService;
...
import net.trader.cointrader.beans.Provider;
import net.trader.cointrader.beans.RecordSide;
import net.trader.cointrader.beans.RecordSideMode;
...
import net.trader.cointrader.exception.NotAvailableMoneyException;
